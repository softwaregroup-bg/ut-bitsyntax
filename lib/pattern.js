...
var TYPES = {'integer': 1, 'binary': 1, 'float': 1, 'string': 1, 'left': 1, 'right': 1, 'zero': 1, 'space': 1, 'bcd': 1, 'xbcd': 1};
...
function add_string_specifiers(segment, specifiers) {
  for (var s in specifiers) {
    if (s == 'left' || s == 'right' || s == 'zero' || s == 'space' || s == 'binhex' || s == 'hexbin' || s == 'bcd'|| s == 'xbcd' || s == 'binary' || s == 'z') {
